...
var _Game = function(board, rack)
{
	...
	function initLetterDistributions_English()
	{
		...
		// {Letter: '&#x0D85;', Score: 1, Count: 12},
		// {Letter: '&#x0D86;', Score: 1, Count: 9},
		// {Letter: '&#x0D87;', Score: 1, Count: 9},
		// {Letter: '&#x0D88;', Score: 1, Count: 8},
		// {Letter: '&#x0D89;', Score: 1, Count: 6},
		// {Letter: '&#3461;', Score: 1, Count: 6},
		// {Letter: '&#3461;', Score: 1, Count: 6},
		// {Letter: "ආ", Score: 1, Count: 4},
		// {Letter: "ආ", Score: 1, Count: 4},
		// {Letter: "ආ", Score: 1, Count: 4},
		
		// {Letter: "ආ", Score: 2, Count: 4},
		// {Letter: "ආ", Score: 2, Count: 3},
		
		// {Letter: "ආ", Score: 3, Count: 2},
		// {Letter: "ආ", Score: 3, Count: 2},
		// {Letter: "ආ", Score: 3, Count: 2},
		// {Letter: "ආ", Score: 3, Count: 2},
		
		// {Letter: "ආ", Score: 4, Count: 2},
		// {Letter: "ආ", Score: 4, Count: 2},
		// {Letter: "ආ", Score: 4, Count: 2},
		// {Letter: "ආ", Score: 4, Count: 2},
		// {Letter: "ආ", Score: 4, Count: 2},
		
		// {Letter: "ආ", Score: 5, Count: 1},
		
		// {Letter: "ආ", Score: 8, Count: 1},
		// {Letter: "ආ", Score: 8, Count: 1},
		
		// {Letter: "ආ", Score: 10, Count: 1},
		// {Letter: "ආ", Score: 10, Count: 1}
		];
	...
	function initLetterDistributions_French()
	{
		...
		{Letter: "ප", Score: 10, Count: 1},
		{Letter: "බ", Score: 10, Count: 1},
		{Letter: "ම", Score: 10, Count: 1},
		{Letter: "ය", Score: 10, Count: 1},
		{Letter: "ර", Score: 10, Count: 1},
		{Letter: "ල", Score: 10, Count: 1},
		{Letter: "ව", Score: 10, Count: 1},
		{Letter: "ස", Score: 10, Count: 1},
		{Letter: "හ", Score: 10, Count: 1},
		{Letter: "ළ", Score: 10, Count: 1},
		{Letter: 'අ', Score: 10, Count: 1},
		{Letter: 'ආ', Score: 1, Count: 9},
		{Letter: 'ආ', Score: 1, Count: 8},
		{Letter: 'ඈ', Score: 1, Count: 6},
		{Letter: 'ඉ', Score: 1, Count: 6},
		{Letter: "ඊ", Score: 1, Count: 6},
		{Letter: "උ", Score: 1, Count: 6},
		{Letter: "ඍ", Score: 1, Count: 6},
		{Letter: "ඎ", Score: 1, Count: 6},
		{Letter: "ඏ", Score: 1, Count: 5},

		{Letter: "ඐ", Score: 1, Count: 5},
		{Letter: "එ", Score: 1, Count: 5},
		{Letter: "ඒ", Score: 1, Count: 5},
		// {Letter: "ඓ", Score: 1, Count: 5},
		{Letter: "ඔ", Score: 1, Count: 5},
		{Letter: "ඕ", Score: 1, Count: 5},
		{Letter: "ඖ", Score: 1, Count: 5},
		{Letter: "ක", Score: 1, Count: 5},
		{Letter: "ඛ", Score: 1, Count: 5},
		{Letter: "ග", Score: 2, Count: 3},
		{Letter: "ඡ", Score: 2, Count: 2},
		// {Letter: "ඣ", Score: 3, Count: 3},	
		{Letter: "ඤ	", Score: 3, Count: 2},
		{Letter: "ඤ", Score: 3, Count: 2},
		{Letter: "ඦ", Score: 3, Count: 2},	
		{Letter: "ඥ", Score: 4, Count: 2},
		{Letter: "ට", Score: 4, Count: 2},
		{Letter: "ඨ", Score: 4, Count: 2},		
		{Letter: "ඩ", Score: 8, Count: 1},
		{Letter: "ඪ", Score: 8, Count: 1},
		{Letter: "ණ	", Score: 10, Count: 1},
		{Letter: "අ", Score: 10, Count: 1},
		{Letter: "ඬ", Score: 10, Count: 1},
		{Letter: "ත", Score: 10, Count: 1},
		{Letter: "ථ", Score: 10, Count: 1},
		{Letter: "ද", Score: 10, Count: 1},	
		{Letter: "ඵ", Score: 10, Count: 1},	
		{Letter: "භ	", Score: 10, Count: 1},	
		{Letter: "ඹ", Score: 10, Count: 1},	
		{Letter: "ශ", Score: 10, Count: 1},
		{Letter: "ෂ", Score: 10, Count: 1}
		...
		else
		{
			...
			switch (square.Type)
			{
				...
				case SquareType.DoubleWord:
					...
					{
						var txt1 = document.createTextNode("වචනය ");
						var txt2 = document.createTextNode("x");
						var txt3 = document.createTextNode(" 2");
				...
				case SquareType.TripleWord:
					...
					var txt1 = document.createTextNode("වචනය x 3");
				...
				case SquareType.DoubleLetter:
					var span = document.createElement('span');
					var txt1 = document.createTextNode("අකුර x 2");
					span.appendChild(txt1);
				...
				case SquareType.TripleLetter:
					var span = document.createElement('span');
					var txt1 = document.createTextNode("අකුර x 3");
					span.appendChild(txt1);
